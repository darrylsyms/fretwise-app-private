...
const buildGlobalStyles = (
	...
	const globalStylesDefault = {
		...
		emptyDesc: {
			...
			lineHeight: Math.ceil(calcFontSize(12) * 2),
			marginBottom: 1
		},
		...
		// complete lesson/topic style. Used On: topic single screen  and lesso single screen
		...
		// Add photos to album option common button text style
	};
